...
import { CTAButtons } from "@/components/home-page/CTAButtons";
import { DashboardPreview } from "@/components/home-page/DashboardPreview";
...
export function HeroSection() {
  return (
    <section
      id="home"
      className="relative flex min-h-[90vh] scroll-mt-[calc(var(--header-height,5.75rem)+1rem)] items-center justify-center"
    >
